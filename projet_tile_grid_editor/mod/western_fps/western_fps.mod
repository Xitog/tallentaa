{
    ...
    "layers" : {
        ...
        "object"  : { "res" : "objects",    "default" : 0,      "apply" : "ammo",      "visible" : true, "icon" : "object", "object" : "Item" },
        "monster" : { "res" : "monsters",   "default" : 0,      "apply" : "enemy1",    "visible" : true, "icon" : "monster", "object" : "Monster"}
    },
    "resources" : {
        "textures" : {
