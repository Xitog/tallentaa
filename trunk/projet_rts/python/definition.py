...
LAYER2_DATA = {
    ...
    9000 : Tile('lvl_bas3'),
   10000 : Tile('lvl_bas4'),
   11000 : Tile('lvl_droit1'),
   12000 : Tile('lvl_droit2'),
   13000 : Tile('lvl_gauche'),
   14000 : Tile('lvl_haut'),
   15000 : Tile('mur_bout1'),
   16000 : Tile('mur_bout2'),
   17000 : Tile('mur_bout3'),
   18000 : Tile('mur_bout4'),
   19000 : Tile('mur_bout5'),
   20000 : Tile('mur_bout6'),
   21000 : Tile('mur_brise'),
   22000 : Tile('mur_coin1'),
   23000 : Tile('mur_coin2'),
   24000 : Tile('mur_coin3'),
   25000 : Tile('mur_coin4'),
   26000 : Tile('mur_horizontal'),
   27000 : Tile('mur_triplet1'),
   28000 : Tile('mur_triplet2'),
   29000 : Tile('mur_triplet3'),
   30000 : Tile('mur_triplet4'),
   31000 : Tile('mur_vertical'),
   34000 : Tile('coin_bas_gauche1'),
   35000 : Tile('coin_bas_gauche2'),
   36000 : Tile('coin_haut_droit'),
   37000 : Tile('coin_haut_gauche'),
}
...
# icons
DOODADS = [
    # filename_ico filename_tex decalage_x decalage_y, size_x, size_y
