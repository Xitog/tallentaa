<html>
    ...
    <table width="100%" height="100%"><tr height="10%"><td></td></tr><tr height="80%"><td align="center" valign="center">
        <div class="main">
        <span></span>
        <table class="invisible"><tr><td align="left"><h1>Ariane</h1><td align="right"><img src="leaf_purple.png" height="60" width="60"/></td></tr></table>
        ...
        <table class="inside">
            <tr>
                ...
                <td class="middle">
                    ...
                    <p class="text">Ariane est un dépôt de guides. Pour l'instant nous avons un guide sur :
                        <ul>
                            <li>Python <i>(draft)</i></li>
                        </ul>
                    </p>
                </td>
                <td class="left">
                    <br/>
                    <center><img src="/images/blueprint.jpg"/></center>
                    <!--
